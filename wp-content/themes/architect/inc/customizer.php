 ...
 */
function architect_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'architect' ),
				'description' => __( 'Height: &gt;80px', 'architect' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar Scheme', 'architect' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'default' => __( 'Default', 'architect' ),
						'inverse' => __( 'Inverse', 'architect' ),
					),
	...
	*/
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'architect' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'fixed'     => __( 'Fixed', 'architect' ),
				'prominent' => __( 'Prominent', 'architect' ),
				'dense'     => __( 'Dense', 'architect' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'architect' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'architect_customize' );
