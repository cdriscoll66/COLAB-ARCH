...
add_filter('timber/context', function ($context) {
    ...
    $context['is_template'] = [];
    $context['is_template']['basic'] = is_page_template('single-page-basic.php') || is_page_template('app/Views/single-page-basic.php');
    $context['is_template']['full'] = is_page_template('single-post-full.php') || is_page_template('app/Views/single-post-full.php') || is_page_template('single-page-full.php') || is_page_template('app/Views/single-page-full.php');;
