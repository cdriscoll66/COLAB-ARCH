...
/**
 * Redirect Platform Domain to Custom Domain
 *
 * @link https://pantheon.io/docs/redirects#redirect-with-php
 *
 * $scheme is defined in wp-config-patheon.php
 */
// if (php_sapi_name() !== 'cli' && !empty($_SERVER['WPCLI_URL'])) :
//     $custom_domain = $_SERVER['WPCLI_URL'];
//
...
/**
 * Redirect Pantheon Environment To Custom Domain
 *
 * @link https://pantheon.io/docs/redirects#redirect-with-php
 *
 * $scheme is defined in wp-config-patheon.php
